...
class Stdent extends Parent {
    rollNumber: string
    courses: string[] = [] // name string hai
    // method 
    registerforCourses(course: Coure) {
...
class Coure {
    ...
    name: string;
    // Making Arrays 
    students: Stdent[] = [] // Assigning class as data type
    instructors: Instrctor[] = []  // Assigning class as data type
    // Making course array 
    ...
    // making method 
    addStudent(st: Stdent) // st parameter dain gy aur us ki data type student dyn gy (aur is parameter ko hamain student ky array main push karna hoga )
    { // student ka object pass karain gy

        this.students.push(st)   // st parameter student array main add kardo
    }
    // making method 
    setInstructor(ing: Instrctor) {
